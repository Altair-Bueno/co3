...
1. **Rust spec** (`TypeSpec`): describe the Rust-specified type properties used by conversion. Projection traits such as `ReprFamily` still exist as the implementation surface for individual axes.
